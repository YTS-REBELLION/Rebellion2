...
CMonsterScript2::CMonsterScript2()
...
void CMonsterScript2::init()
{
	CGameObject* pSwordCol = new CGameObject;
	pSwordCol->SetName(L"MonsterSwordCol2");
	...
	GetObj()->GetScript<CMonsterScript2>()->SetColSSA(pSwordCol);

	CSceneMgr::GetInst()->GetCurScene()->AddGameObject(L"MonsterSword", pSwordCol, false);
}

void CMonsterScript2::awake()
{
...
void CMonsterScript2::update()
{
	...
	CMonsterScript2* Monster = GetObj()->GetScript<CMonsterScript2>();
	...
	if (m_Is_Move) {
		...
		//if (GetObj()->Animator3D()->GetCliTime(2) > 0.75f)
		//{
		//	pSwordColObject->SetActive(true);
		//}
		//else if (GetObj()->Animator3D()->GetCliTime(2) == 0.f)
...
void CMonsterScript2::UpdateLerpPos()
{
...
void CMonsterScript2::SetMonsterAnimationData(Ptr<CMesh> AniDate, const int& i, const UINT& _StartFrame, const UINT& _EndFrame)
{
...
void CMonsterScript2::SetMonsterAnimation(const int& i)
{
...
void CMonsterScript2::SetMonsterAnimation(int other_id, const int& i)
{
...
void CMonsterScript2::AnimationPlay(const MONSTER_ANI_TYPE& type)
{
...
void CMonsterScript2::AnimationPlay(int other_id, const MONSTER_ANI_TYPE& type)
{
	if (type == MONSTER_ANI_TYPE::IDLE)
	{
...
void CMonsterScript2::SetOtherMovePacket(sc_packet_move* p)
{
...
void CMonsterScript2::SetMonsterPacket(sc_packet_npc_attack* p)
{
...
void CMonsterScript2::OnCollisionEnter(CCollider2D* _pOther)
{
...
void CMonsterScript2::OnCollision(CCollider2D* _pOther)
{
}

void CMonsterScript2::OnCollisionExit(CCollider2D* _pOther)
{
